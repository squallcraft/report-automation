...
def _registrar_movimiento_sueldo(
    ...
    mov = MovimientoFinanciero(
        ...
        descripcion=f"Pago nómina generado automáticamente desde módulo Pagos Trabajadores",
        monto=pago.monto,
        moneda="CLP",
        mes=pago.mes,
        anio=pago.anio,
