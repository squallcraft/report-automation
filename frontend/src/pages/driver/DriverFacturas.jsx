      ...
      <div className="card mb-4 sm:mb-6">
        ...
        <div className="flex flex-wrap items-end gap-3 sm:gap-4">
          <div>
            ...
            <select className="input-field text-xs sm:text-sm w-24 sm:w-auto" value={semana}
        ...
        {facturaActual && (
          <div className={`mt-3 p-3 rounded-lg border ${ESTADO_CONFIG[facturaActual.estado]?.cls || 'bg-gray-50 border-gray-200'}`}>
                  ...
                  <tr key={f.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3">
                      <div className="flex flex-col gap-1">
                        ...
                        {f.nota_admin && (
                          <span className="text-[10px] text-red-500 max-w-[160px] truncate" title={f.nota_admin}>
                            {f.nota_admin}
                          </span>
                        )}
                      </div>
