...
export default function SellerConsultas() {
          ...
          <div className="space-y-4">
            ...
            {detail.respuesta && (
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">{detail.respondida_en ? new Date(detail.respondida_en).toLocaleString('es-CL') : ''}</p>
              </div>
            )}
